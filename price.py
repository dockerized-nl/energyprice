...
URL = f"https://api.energyzero.nl/v1/energyprices?fromDate={current_date.strftime('%Y-%m-%d')}T15:00:00.000Z&tillDate={tomorrow.strftime('%Y-%m-%d')}T15:00:00.000Z&interval=4&usageType=1&inclBtw=true"
